...
export default class extends Controller {
    ...
    addLine() {
        ...
        wrapper.dataset.shipmentFormTarget = 'row';
        wrapper.innerHTML = `<div>${html}</div><button type="button" class="btn btn-ghost" data-action="shipment-form#removeLine">Remove</button>`;
